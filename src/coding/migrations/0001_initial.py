...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='question',
            name='ques_set',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='coding.questionset', verbose_name='所属题库'),
        ),
        migrations.CreateModel(
            name='QuesAnswerRec',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('paper_class', models.IntegerField(choices=[(-1, '未知'), (0, '考试'), (1, '练习')], default=-1, verbose_name='试卷类型')),
        ...
        migrations.AddField(
            model_name='paper',
            name='question',
            field=models.ManyToManyField(through='coding.Questionswithscore', to='coding.Question', verbose_name='题目列表'),
        ),
        migrations.CreateModel(
            name='Exercise',
            fields=[
