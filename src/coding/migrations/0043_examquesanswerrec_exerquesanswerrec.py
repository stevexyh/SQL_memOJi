# Generated by Django 3.1.7 on 2022-02-06 13:20
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('coding', '0042_auto_20220206_2119'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('exer', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='coding.exeranswerrec', verbose_name='对应练习')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('submit_time', models.DateTimeField(auto_now=True, verbose_name='最后提交时间')),
                ('submit_cnt', models.IntegerField(default=0, verbose_name='提交次数')),
                ('exam', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='coding.examanswerrec', verbose_name='对应考试')),
                ('question', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='coding.question', verbose_name='题目')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='用户')),
            ],
            options={
